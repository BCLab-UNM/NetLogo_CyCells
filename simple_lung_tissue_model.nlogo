;; slider for num incec
;; random virus defusion
globals[ probablility ]
...
to setup_cells
  set probablility 100
  ask patches[set state "heathy"]
  repeat Sites_of_infection [
    infect_cell patch random-xcor random-ycor
  ]
  set probablility probablility_of_spread
end
...
to infect_cell [pat]
  ask pat[
    if (state = "heathy") and (random 100 <= probablility)[    ;; introduce probablility here!
...
to spawn_t_cells
  if ticks > 120[
    create-t_cell t_cell_production_rate[
      set size 5 set color green
      set shape "circle"
      setxy random-xcor random-ycor
      set age age_in_blood
      set spd t_cell_speed]
  ]
end
...
to spawn_chemokine
  ask patches with [state = "secreting"][sprout-chemokine 1[set color blue set size 2 set shape "circle" set direction random 359 hide-turtle]]
end
...
"" ""
PENS
"default" 1.0 0 -16777216 true "" "plot count patches with [state != \"heathy\" and state != \"dead\"]"
...
"" ""
PENS
"default" 1.0 0 -16777216 true "" "plot count patches with [state = \"dead\"]"
...
"" ""
PENS
"default" 1.0 0 -16777216 true "" "plot count patches with [state = \"heathy\"]"
...
"" ""
PENS
"default" 1.0 0 -16777216 true "" "plot count t_cell"
...
@#$#@#$#@
=======
>>>>>>> ccba294d7ccdcacf3abb0aa2f2cce67011251809
